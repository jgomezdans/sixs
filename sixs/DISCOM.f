...
c line above attempts to access wldis(21) for l=20
c fixed with 2 nested if statements --- KJP 15/4/11
        if (l.lt.20) then      
...
c     Legendre polynomials.
	...
	if (iaer.ne.0) call trunca(coeff,ipol) ! the routine is modified
     ...
     a      nfilut,filut,rolut,rolutq,rolutu)
        ...
        roatm(3,l)=roaero
c     KJP debug lines
c        write(6,*) 'DISCOM:rorayl',rorayl
c        write(6,*)'DISCOM:romix',romix
c        write(6,*)'DISCOM:roaero',roaero
c        write(6,*) roatm(1,l),roatm(2,l),roatm(3,l),l
c        pause
