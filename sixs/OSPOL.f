...
c
 ...
 716  continue
      ...
      enddo
c     KJP Debug lines
c      write(6,*) 'OSPOL:xli=',xli,'np=',np,'-mu=',-mu,'xmus=',xmus
c      pause
...
c KJP Debug lines
c              if ((i2(k,j)> -1) .and. (q2(k,j)> -1) .and.
c     &           (u2(k,j)> -1) )then 
c                     continue 
c              else 
c                  write(6,*) 'i2(',k,',',j,')=',i2(k,j)
c                  write(6,*) 'q2(',k,',',j,')=',q2(k,j)
c                  write(6,*) 'u2(',k,',',j,')=',u2(k,j)
c                  write(6,*) 'a=',a,'b=',b,'c=',c
c                  write(6,*) 'sa1=',sa1,'sa2=',sa2
c                  write(6,*) 'sb1=',sb1,'sb2=',sb2
c                  write(6,*) 'sc1=',sc1,'sc2=',sc2
c                  pause
c              endif
  101     continue
  100   continue
...
c               continue
c            else
c                write(6,*) 'i1(',i,',',k,')=',i1(i,k)
c                write(6,*) 'a=',a,'b=',b,'c=',c,'d=',d,'xx=',xx,'yy=',yy
c                write(6,*) 'i2(',i,',',k,')=',i2(i,k)
c                write(6,*) 'i2(',jj,',',k,')=',i2(jj,k)
c                write(6,*) 'f=',f
c            endif
...
c               continue
c            else
c                write(6,*) 'q1(',i,',',k,')=',q1(i,k)
c                write(6,*) 'a=',a,'b=',b,'c=',c,'d=',d,'xx=',xx,'yy=',yy
c                write(6,*) 'q2(',i,',',k,')=',q2(i,k)
c                write(6,*) 'q2(',jj,',',k,')=',q2(jj,k)
c                write(6,*) 'f=',f
c            endif
...
c               continue
c            else
c                write(6,*) 'u1(',i,',',k,')=',u1(i,k)
c                write(6,*) 'a=',a,'b=',b,'c=',c,'d=',d,'xx=',xx,'yy=',yy
c                write(6,*) 'u2(',i,',',k,')=',u2(i,k)
c                write(6,*) 'u2(',jj,',',k,')=',u2(jj,k)
c                write(6,*) 'f=',f
c            endif

  109   continue
c     KJP debug lines
c        do 10000 kjpk=-mu,mu
c           do 10000 kjpl=0,nt
c              if ((i1(kjpl,kjpk)> -1) .and. (q1(kjpl,kjpk)> -1) .and.
c     &           (u1(kjpl,kjpk)> -1) )then 
c                     continue 
c              else 
c                  write(6,*) 'i1(',kjpl,',',kjpk,')=',i1(kjpl,kjpk)
c                  write(6,*) 'q1(',kjpl,',',kjpk,')=',q1(kjpl,kjpk)
c                  write(6,*) 'u1(',kjpl,',',kjpk,')=',u1(kjpl,kjpk)
c                  pause
c              endif
c10000   continue
...
c
   ...
   25     continue
          ...
          u3(k)=u1(index,k)
c     Debug KJP added
c          write(6,*) 'second OSPOL: is=',is,'i3(',k,')=',i3(k)
...
c
c     KJP Debug lines
c        write(6,*) 'OSCOM: before if test is=',is,' k=',k
c        pause
...
c
 ...
 614    continue
c      write(6,*) xli,np,mum1,delta0s,i3(mum1),is,phi,pi,cos(is*(phi+pi))
c     KJP debug lines
c      write(6,*) 'OSPOL: xli(mum1,np)=',xli(mum1,np),'i3(mum1)=',i3(mum1)
c      pause 
